...
4. To build the sample from the command line:
     ...
     - Go to Cpp\Code Samples\QtEyeTrackingSample and run "build [Win32|x64] [Release|Debug]". This builds and 
...
3. You need Boost libraries.
     - Install it with: sudo port install boost -no_static -no_single +universal +python26
4. You need QT libraries.
