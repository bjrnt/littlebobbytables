/* $Id: game_preferences_display.cpp 54625 2012-07-08 14:26:21Z loonycyborg $ */
/*
...
//
	...
	enum TAB {	EYETRACKING_TAB, GENERAL_TAB, DISPLAY_TAB, SOUND_TAB, MULTIPLAYER_TAB, ADVANCED_TAB,
				/*extra tab*/
...
void show_preferences_dialog(display& disp, const config& game_cfg)
{
	...
	items.push_back(pre + "eyetracking.png" + sep + "Eyetracking");
